            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-2 mt-5 justify-items-center'>
                        ...
                        <input type="number" name='number' placeholder="Number" class="input input-bordered w-full max-w-xs" />
                        <input type="submit" value="Submit" class="input input-bordered w-full max-w-xs bg-black text-white" />
                    </form>
                </div>
            </div>
        </div>
